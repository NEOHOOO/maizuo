...
var _isActive2 = __webpack_require__(90);

var _isActive3 = _interopRequireDefault(_isActive2);

var _getComponents = __webpack_require__(87);
...
var CardComponent = function (_React$Component) {
    ...
    function CardComponent(props, context) {
        _classCallCheck(this, CardComponent);

        var _this = _possibleConstructorReturn(this, (CardComponent.__proto__ || Object.getPrototypeOf(CardComponent)).call(this, props, context));
...
var HomeComponent = function (_React$Component) {
    ...
    function HomeComponent(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (HomeComponent.__proto__ || Object.getPrototypeOf(HomeComponent)).call(this, props, context));
...
var MovieComponent = function (_React$Component) {
    _inherits(MovieComponent, _React$Component);

    function MovieComponent(props, context) {
        _classCallCheck(this, MovieComponent);

        var _this = _possibleConstructorReturn(this, (MovieComponent.__proto__ || Object.getPrototypeOf(MovieComponent)).call(this, props, context));
...
var MyComponent = function (_React$Component) {
    ...
    function MyComponent(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (MyComponent.__proto__ || Object.getPrototypeOf(MyComponent)).call(this, props, context));
...
var RootComponent = function (_React$Component) {
    ...
    _createClass(RootComponent, [{
        ...
        key: 'render',
        value: function render() {
            var isFromShow = this.state.isFromShow;

            return React.createElement(
                'div',
                { className: 'full-height' },
                React.createElement(_HeadComponent2.default, { ToggleFrom: this.ToggleFrom.bind(this) }),
                this.props.children,
                React.createElement(_FooterComponent2.default, { isFromShow: isFromShow })
            );
        }
    }]);
...
var StoreComponent = function (_React$Component) {
    ...
    function StoreComponent(props, context) {
        _classCallCheck(this, StoreComponent);

        var _this = _possibleConstructorReturn(this, (StoreComponent.__proto__ || Object.getPrototypeOf(StoreComponent)).call(this, props, context));
...
var _History2 = __webpack_require__(74);
...
var _HomeComponent = __webpack_require__(50);

var _HomeComponent2 = _interopRequireDefault(_HomeComponent);

var _CardComponent = __webpack_require__(49);

var _CardComponent2 = _interopRequireDefault(_CardComponent);

var _MovieComponent = __webpack_require__(51);

var _MovieComponent2 = _interopRequireDefault(_MovieComponent);

var _MoviesComponent = __webpack_require__(52);

var _MoviesComponent2 = _interopRequireDefault(_MoviesComponent);

var _MyComponent = __webpack_require__(53);

var _MyComponent2 = _interopRequireDefault(_MyComponent);

var _StoreComponent = __webpack_require__(55);
...
ReactDOM.render(React.createElement(
    ...
    React.createElement(
        ...
        React.createElement(_reactRouter.IndexRoute, { component: _HomeComponent2.default }),
        React.createElement(_reactRouter.Route, { path: 'home', component: _HomeComponent2.default }),
        React.createElement(_reactRouter.Route, { path: 'movie', component: _MovieComponent2.default }),
        React.createElement(_reactRouter.Route, { path: 'movies', component: _MoviesComponent2.default }),
        React.createElement(_reactRouter.Route, { path: 'my', component: _MyComponent2.default }),
        React.createElement(_reactRouter.Route, { path: 'store', component: _StoreComponent2.default }),
        React.createElement(_reactRouter.Route, { path: 'card', component: _CardComponent2.default }),
...
var FooterComponent = function (_React$Component) {
    ...
    _createClass(FooterComponent, [{
        key: "render",
        value: function render() {
            var isFromShow = this.props.isFromShow;

            return React.createElement(
                "div",
                { className: isFromShow ? "footer show" : "footer" },
                React.createElement(
                    "ul",
                    null,
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement("span", { className: "iconfont icon-you" })
                        )
                    ),
                    React.createElement(
                        "li",
...
var HeadComponent = function (_React$Component) {
    ...
    _createClass(HeadComponent, [{
        key: "render",
        value: function render() {
            var ToggleFrom = this.props.ToggleFrom;
            ...
            return React.createElement(
                ...
                React.createElement(
                    "div",
                    null,
                    React.createElement("span", { className: "iconfont icon-menu", id: "s3", onClick: ToggleFrom }),
                    React.createElement(
                        "span",
                        { className: "s1" },
                        "\u5356\u5EA7\u7535\u5F71"
                    ...
                    React.createElement(
                        ...
                        { className: "s2" },
                        "\u5317\u4EAC",
                        React.createElement("i", { className: "iconfont icon-jiantou-down" })
                    ),
                    React.createElement("span", { className: "iconfont icon-icon-test" })
                )
            );
        }
    }]);
